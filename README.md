...
instance:
  ...
  # volume_tags:
  #   enabled: true # (Optional) Tag every attached volume through the instance-level volume_tags attribute. Set false to tag the root and EBS block devices individually instead. Default: true.
  #   extra_tags: {} # (Optional) Additional tags merged into the computed volume tags. Default: {}.
  #   # Computed volume tags = common module tags + extra_tags + Name: "<instance name>" + InstanceName: "<instance name>".
